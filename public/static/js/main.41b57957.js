!(function (e) {
  ...
  (function (e) {
    ...
    function (e, t) {
      ...
      (t.APP_LOAD = 'APP_LOAD'),
        (t.REDIRECT = 'REDIRECT'),
        (t.ARTICLE_SUBMITTED = 'ARTICLE_SUBMITTED'),
        (t.SETTINGS_SAVED = 'SETTINGS_SAVED'),
        (t.DELETE_ARTICLE = 'DELETE_ARTICLE'),
        (t.SETTINGS_PAGE_UNLOADED = 'SETTINGS_PAGE_UNLOADED'),
        (t.HOME_PAGE_LOADED = 'HOME_PAGE_LOADED'),
        (t.HOME_PAGE_UNLOADED = 'HOME_PAGE_UNLOADED'),
        (t.ARTICLE_PAGE_LOADED = 'ARTICLE_PAGE_LOADED'),
        (t.ARTICLE_PAGE_UNLOADED = 'ARTICLE_PAGE_UNLOADED'),
        (t.ADD_COMMENT = 'ADD_COMMENT'),
        (t.DELETE_COMMENT = 'DELETE_COMMENT'),
        (t.ARTICLE_FAVORITED = 'ARTICLE_FAVORITED'),
        (t.ARTICLE_UNFAVORITED = 'ARTICLE_UNFAVORITED'),
        (t.SET_PAGE = 'SET_PAGE'),
        (t.APPLY_TAG_FILTER = 'APPLY_TAG_FILTER'),
        (t.CHANGE_TAB = 'CHANGE_TAB'),
        (t.PROFILE_PAGE_LOADED = 'PROFILE_PAGE_LOADED'),
        (t.PROFILE_PAGE_UNLOADED = 'PROFILE_PAGE_UNLOADED'),
        (t.LOGIN = 'LOGIN'),
        (t.LOGOUT = 'LOGOUT'),
        (t.REGISTER = 'REGISTER'),
        (t.LOGIN_PAGE_UNLOADED = 'LOGIN_PAGE_UNLOADED'),
        (t.REGISTER_PAGE_UNLOADED = 'REGISTER_PAGE_UNLOADED'),
        (t.ASYNC_START = 'ASYNC_START'),
        (t.ASYNC_END = 'ASYNC_END'),
        (t.EDITOR_PAGE_LOADED = 'EDITOR_PAGE_LOADED'),
        (t.EDITOR_PAGE_UNLOADED = 'EDITOR_PAGE_UNLOADED'),
        (t.ADD_TAG = 'ADD_TAG'),
        (t.REMOVE_TAG = 'REMOVE_TAG'),
        (t.UPDATE_FIELD_AUTH = 'UPDATE_FIELD_AUTH'),
        (t.UPDATE_FIELD_EDITOR = 'UPDATE_FIELD_EDITOR'),
        (t.FOLLOW_USER = 'FOLLOW_USER'),
        (t.UNFOLLOW_USER = 'UNFOLLOW_USER');
    },
    function (e, t) {
      'use strict';
      function n(e) {
    ...
    function (e, t, n) {
      (function (e) {
        ...
        var o = n(290),
          ...
          g = function (e) {
            return Object.assign({}, e, { slug: void 0 });
          },
          b = {
            all: function (e) {
            ...
            update: function (e) {
              return h.put('/articles/' + e.slug, { article: g(e) });
            },
            create: function (e) {
              return h.post('/articles', { article: e });
            },
          },
          _ = {
            create: function (e, t) {
              return h.post('/articles/' + e + '/comments', { comment: t });
            },
            delete: function (e, t) {
    ...
    function (e, t, n) {
      ...
      (t.BrowserRouter = a.default),
        ...
        (t.Switch = P.default),
        (t.matchPath = x.default),
        (t.withRouter = A.default);
    },
    function (e, t, n) {
      'use strict';
      var r = function () {};
      ...
      function o() {
        this.reinitializeTransaction(),
          ...
          (this.reconcileTransaction =
            k.ReactReconcileTransaction.getPooled(!0));
      }
      ...
      var o = n(182),
        ...
        c = function (e) {
          ...
          var n = t,
            ...
            c = n.sensitive,
            p = void 0 !== c && c,
            f = l(o, { end: i, strict: u, sensitive: p }),
            d = f.re,
            h = f.keys,
            m = d.exec(e);
          if (!m) return null;
        ...
        b = function () {
          ...
          var t = window.history,
            ...
            P = function (e) {
              o(Y, e),
                (Y.length = t.length),
                O.notifyListeners(Y.location, Y.action);
            },
            T = !1,
            x = null,
            k = function () {
            ...
            j = function (e, t) {
              ...
              O.confirmTransitionTo(r, n, a, function (e) {
                if (e) {
                  ...
                  i !== -1 && (D[i] = t), P({ action: n, location: r });
                }
              });
            },
            U = function (e) {
      ...
      var s = (function () {
        ...
        y = function (e) {
          return e.isUser
            ? p.default.createElement(
                ...
                p.default.createElement('i', { className: 'ion-gear-a' }),
        ...
        g = function (e) {
          ...
          var n = function (t) {
            t.preventDefault(),
              e.user.following
                ? e.unfollow(e.user.username)
                : e.follow(e.user.username);
          };
          return p.default.createElement(
            'button',
            { className: t, onClick: n },
            p.default.createElement('i', { className: 'ion-plus-round' }),
            ' ',
            e.user.following ? 'Unfollow' : 'Follow',
            ' ',
            e.user.username,
          );
        },
        ...
        _ = function (e) {
          return {
            ...
            onLoad: function (t) {
              return e({ type: v.PROFILE_PAGE_LOADED, payload: t });
            },
            ...
            onUnload: function () {
              return e({ type: v.PROFILE_PAGE_UNLOADED });
            },
          };
        },
        E = (function (e) {
            ...
            s(t, [
              {
                ...
                value: function () {
                  this.props.onLoad(
                    Promise.all([
                      h.default.Profile.get(this.props.match.params.username),
                      h.default.Articles.byAuthor(
                      ...
                      p.default.createElement(
                        ...
                        p.default.createElement(
                          ...
                          p.default.createElement(
                            ...
                            p.default.createElement('h4', null, e.username),
                            p.default.createElement('p', null, e.bio),
                            p.default.createElement(y, { isUser: t }),
    ...
    function (e, t, n) {
      ...
      var o = n(43),
        ...
        h = function () {
          return (0, o.applyMiddleware)(
            d,
            i.promiseMiddleware,
            i.localStorageMiddleware,
          );
        };
                ...
                if (e) {
                  ...
                  if (n)
                    if ((t.pushState({ key: o, state: l }, null, r), u))
                      ...
                      p.push(i.key), (R = p), P({ action: a, location: i });
                    }
                  else
                    (0, s.default)(
                      void 0 === l,
                ...
                if (e) {
                  ...
                  if (n)
                    if ((t.replaceState({ key: o, state: l }, null, r), u))
                      ...
                      var c = R.indexOf(V.location.key);
                      c !== -1 && (R[c] = i.key), P({ action: a, location: i });
                    }
                  else
                    (0, s.default)(
                      void 0 === l,
              ...
              (F += e),
                1 === F
                  ? ((0, h.addEventListener)(window, m, T),
                    r && (0, h.addEventListener)(window, v, x))
                  : 0 === F &&
                    ((0, h.removeEventListener)(window, m, T),
                    r && (0, h.removeEventListener)(window, v, x));
            },
            B = !1,
            q = function () {
              var e =
              ...
              m.confirmTransitionTo(a, r, t, function (e) {
                if (e) {
                  ...
                  o.length > n ? o.splice(n, o.length - n, a) : o.push(a),
                    v({ action: r, location: a, index: n, entries: o });
                }
              });
            },
            w = function (e, n) {
              ...
              var r = 'REPLACE',
                a = (0, l.createLocation)(e, n, y(), A.location);
              m.confirmTransitionTo(a, r, t, function (e) {
                e && ((A.entries[A.index] = a), v({ action: r, location: a }));
              });
            },
            C = function (e) {
    ...
    function (e, t, n) {
      ...
      function u(e, t, n) {
        for (
          O.unmountComponent(e, n), t.nodeType === D && (t = t.documentElement);
          t.lastChild;
      ...
      function c(e) {
        return !(
          !e ||
          (e.nodeType !== M && e.nodeType !== D && e.nodeType !== I)
        );
      }
      function p(e) {
        var t = o(e),
      ...
      var F = {
        ...
        unmountComponentAtNode: function (e) {
          ...
          return (
            delete L[t._instance.rootID], T.batchedUpdates(u, t, e, !1), !0
          );
        },
    ...
    function (e, t, n) {
      ...
      (x.propTypes = {
        ...
        (x.childContextTypes = { router: v.default.object.isRequired }),
        (t.default = x);
    },
    function (e, t, n) {
      'use strict';
        ...
        h = function (e) {
          var t = function (t) {
            ...
            return s.default.createElement(d.default, {
              render: function (t) {
                return s.default.createElement(e, a({}, r, t, { ref: n }));
              },
            });
          };
          return (
    ...
    function (e, t, n) {
      ...
      function o(e, t, n) {
        ...
        return (
          c({ type: l.INIT }),
          (d = { dispatch: c, subscribe: s, getState: a, replaceReducer: p }),
          (d[u.default] = f),
          d
        );
      }
            ...
            s(t, [
              {
                ...
                value: function (e) {
                  e.redirectTo &&
                    (M.store.dispatch((0, D.push)(e.redirectTo)),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e && l.default.setToken(e),
                    this.props.onLoad(e ? l.default.Auth.current() : null, e);
                },
              },
              {
                key: 'render',
      ...
      var o = n(2),
        ...
        h = function (e) {
          var t = e.article,
            ...
            r = function (n) {
              n.preventDefault(),
                t.favorited ? e.unfavorite(t.slug) : e.favorite(t.slug);
            };
          return a.default.createElement(
            ...
            a.default.createElement(
              ...
              a.default.createElement(
                ...
                a.default.createElement(
                  i.Link,
                  { className: 'author', to: '/@' + t.author.username },
                  t.author.username,
                ),
                a.default.createElement(
                  'span',
              ...
              a.default.createElement(
                ...
                a.default.createElement(
                  ...
                  a.default.createElement('i', { className: 'ion-heart' }),
                  ' ',
                  t.favoritesCount,
                ),
              ),
            ...
            a.default.createElement(
              i.Link,
              { to: '/article/' + t.slug, className: 'preview-link' },
              a.default.createElement('h1', null, t.title),
              a.default.createElement('p', null, t.description),
              a.default.createElement('span', null, 'Read more...'),
              a.default.createElement(
                'ul',
                { className: 'tag-list' },
                t.tagList.map(function (e) {
                  return a.default.createElement(
                    'li',
                    { className: 'tag-default tag-pill tag-outline', key: e },
                    e,
                  );
                }),
              ),
        ...
        p = function (e) {
          return {
            onClickDelete: function (t) {
              return e({ type: c.DELETE_ARTICLE, payload: t });
            },
          };
        },
        f = function (e) {
          ...
          return e.canModify
            ? i.default.createElement(
                ...
                i.default.createElement(
                  ...
                  i.default.createElement('i', { className: 'ion-edit' }),
                  ' Edit Article',
                ),
                i.default.createElement(
                  'button',
                  { className: 'btn btn-outline-danger btn-sm', onClick: n },
                  i.default.createElement('i', { className: 'ion-trash-a' }),
                  ' Delete Article',
                ),
              )
        ...
        l = function (e) {
          ...
          return u.default.createElement(
            ...
            u.default.createElement(
              ...
              u.default.createElement(
                i.Link,
                { to: '/@' + t.author.username, className: 'author' },
                t.author.username,
              ),
              u.default.createElement(
                'span',
        ...
        l = function (e) {
          ...
          return u.default.createElement(
            ...
            u.default.createElement(
              ...
              u.default.createElement('p', { className: 'card-text' }, t.body),
            ),
            u.default.createElement(
              'div',
              ...
              u.default.createElement(
                i.Link,
                { to: '/@' + t.author.username, className: 'comment-author' },
                u.default.createElement('img', {
                  src: t.author.image,
          ...
          return e.currentUser
            ? c.default.createElement(
                ...
                c.default.createElement(
                  'div',
                  null,
                  c.default.createElement('list-errors', { errors: e.errors }),
            ...
            : c.default.createElement(
                ...
                c.default.createElement(
                  'p',
                  null,
                  c.default.createElement(u.Link, { to: '/login' }, 'Sign in'),
                  ' or ',
                  c.default.createElement(
                    u.Link,
                    { to: '/register' },
    ...
    function (e, t, n) {
      ...
      var s = (function () {
        ...
        h = function (e) {
          return {
            onSubmit: function (t) {
              return e({ type: d.ADD_COMMENT, payload: t });
            },
          };
        },
        m = (function (e) {
          function t() {
            ...
            return (
              ...
              (e.setBody = function (t) {
                e.setState({ body: t.target.value });
              }),
              (e.createComment = function (t) {
                ...
                e.setState({ body: '' }), e.props.onSubmit(n);
              }),
              e
            );
          }
        ...
        c = function (e) {
          return {
            onClick: function (t, n) {
              return e({ type: l.DELETE_COMMENT, payload: t, commentId: n });
            },
          };
        },
        p = function (e) {
    ...
    function (e, t, n) {
      ...
      var s = (function () {
        ...
        E = function (e) {
          return {
            onLoad: function (t) {
              return e({ type: b.ARTICLE_PAGE_LOADED, payload: t });
            },
            onUnload: function () {
              return e({ type: b.ARTICLE_PAGE_UNLOADED });
            },
          };
        },
        w = (function (e) {
            ...
            s(t, [
              {
                ...
                value: function () {
                  this.props.onLoad(
                    Promise.all([
                      m.default.Articles.get(this.props.match.params.id),
                      m.default.Comments.forArticle(this.props.match.params.id),
                    ]),
                  );
                },
              },
                ...
                value: function () {
                  ...
                  return d.default.createElement(
                    ...
                    d.default.createElement(
                      ...
                      d.default.createElement('hr', null),
                      d.default.createElement('div', {
    ...
    function (e, t, n) {
      ...
      var s = (function () {
        ...
        y = function (e) {
          return {
            onAddTag: function () {
              return e({ type: m.ADD_TAG });
            },
            onLoad: function (t) {
              return e({ type: m.EDITOR_PAGE_LOADED, payload: t });
            },
            onRemoveTag: function (t) {
              return e({ type: m.REMOVE_TAG, tag: t });
            },
            onSubmit: function (t) {
              return e({ type: m.ARTICLE_SUBMITTED, payload: t });
            },
            onUnload: function (t) {
              return e({ type: m.EDITOR_PAGE_UNLOADED });
            },
            onUpdateField: function (t, n) {
              return e({ type: m.UPDATE_FIELD_EDITOR, key: t, value: n });
            },
          };
        },
        g = (function (e) {
          function t() {
            ...
            return (
              (e.changeTitle = n('title')),
              (e.changeDescription = n('description')),
              (e.changeBody = n('body')),
              (e.changeTagInput = n('tagInput')),
              (e.watchForEnter = function (t) {
              ...
              (e.submitForm = function (t) {
                ...
                var n = {
                  ...
                  r = { slug: e.props.articleSlug },
                  o = e.props.articleSlug
                    ? d.default.Articles.update(Object.assign(n, r))
                    : d.default.Articles.create(n);
                e.props.onSubmit(o);
              }),
              e
            );
            ...
            s(t, [
              {
                ...
                value: function (e) {
                  if (this.props.match.params.slug !== e.match.params.slug) {
                    if (e.match.params.slug)
                      return (
                        this.props.onUnload(),
                        this.props.onLoad(
                          d.default.Articles.get(this.props.match.params.slug),
                        )
                      );
          ...
          return e.currentUser
            ? l.default.createElement(
                ...
                l.default.createElement(
                  ...
                  l.default.createElement(
                    c.Link,
                    { to: '/editor', className: 'nav-link' },
                    l.default.createElement('i', { className: 'ion-compose' }),
                    ' New Post',
                  ),
                ),
                l.default.createElement(
                  ...
                  l.default.createElement(
                    ...
                    l.default.createElement('i', { className: 'ion-gear-a' }),
                    ' Settings',
                  ),
                ),
                l.default.createElement(
          ...
          return e.tag
            ? s.default.createElement(
                ...
                s.default.createElement(
                  ...
                  s.default.createElement('i', { className: 'ion-pound' }),
                  ' ',
                  e.tag,
                ),
              )
        ...
        v = function (e) {
          return {
            onTabClick: function (t, n, r) {
              return e({ type: p.CHANGE_TAB, tab: t, pager: n, payload: r });
            },
          };
        },
        y = function (e) {
          return s.default.createElement(
            ...
            s.default.createElement(
              ...
              s.default.createElement(
                ...
                s.default.createElement(h, { tag: e.tag }),
              ),
            ),
        ...
        var s = (function () {
          ...
          w = function (e) {
            return {
              ...
              onUnload: function () {
                return e({ type: b.HOME_PAGE_UNLOADED });
              },
            };
          },
          C = (function (e) {
              ...
              s(t, [
                {
                  ...
                  value: function () {
                    var e = this.props.token ? 'feed' : 'all',
                      t = this.props.token
                        ? y.default.Articles.feed
                        : y.default.Articles.all;
                    this.props.onLoad(
                      e,
                      t,
                      _.all([y.default.Tags.getAll(), t()]),
                    );
                  },
                },
                {
        ...
        c = function (e) {
          return {
            onSetPage: function (t, n) {
              return e({ type: l.SET_PAGE, page: t, payload: n });
            },
          };
        },
        p = function (e) {
          if (e.articlesCount <= 10) return null;
          for (var t = [], n = 0; n < Math.ceil(e.articlesCount / 10); ++n)
            t.push(n);
          var r = function (t) {
            e.pager
              ? e.onSetPage(t, e.pager(t))
              : e.onSetPage(t, s.default.Articles.all(t));
          };
          return a.default.createElement(
            'nav',
            null,
        ...
        g = function (e) {
          return {
            onChangeEmail: function (t) {
              return e({ type: v.UPDATE_FIELD_AUTH, key: 'email', value: t });
            },
            ...
            onSubmit: function (t, n) {
              return e({ type: v.LOGIN, payload: h.default.Auth.login(t, n) });
            },
            onUnload: function () {
              return e({ type: v.LOGIN_PAGE_UNLOADED });
            },
          };
        },
        b = (function (e) {
    ...
    function (e, t, n) {
      ...
      var s = (function () {
        ...
        v = function (e) {
          return {
            onLoad: function (t, n) {
              return e({ type: m.PROFILE_PAGE_LOADED, pager: t, payload: n });
            },
            onUnload: function () {
              return e({ type: m.PROFILE_PAGE_UNLOADED });
            },
          };
        },
        y = (function (e) {
            ...
            s(t, [
              {
                ...
                value: function () {
                  ...
                  this.props.onLoad(
                    function (t) {
                      return d.default.Articles.favoritedBy(
                        e.props.match.params.username,
                        t,
                      );
                    },
                    Promise.all([
                      d.default.Profile.get(this.props.match.params.username),
                      d.default.Articles.favoritedBy(
                        this.props.match.params.username,
                      ),
                    ]),
                  );
        ...
        g = function (e) {
          return {
            ...
            onSubmit: function (t, n, r) {
              ...
              e({ type: v.REGISTER, payload: o });
            },
            onUnload: function () {
              return e({ type: v.REGISTER_PAGE_UNLOADED });
            },
          };
        },
        b = (function (e) {
      ...
      var u = (function () {
        ...
        b = function (e) {
          return {
            ...
            onUnload: function () {
              return e({ type: v.SETTINGS_PAGE_UNLOADED });
            },
          };
        },
        _ = (function (e) {
                    ...
                    f.default.createElement(
                      ...
                      f.default.createElement(
                        ...
                        f.default.createElement(
                          ...
                          f.default.createElement('hr', null),
                          f.default.createElement(
                            'button',
                            {
      ...
      var a = n(8),
        ...
        u = function (e) {
          return function (t) {
            return function (n) {
              if (o(n.payload)) {
                e.dispatch({ type: s.ASYNC_START, subtype: n.type });
                var r = e.getState().viewChangeCounter,
                  a = n.skipTracking;
                return void n.payload.then(
                  function (t) {
                    var o = e.getState();
                    (a || o.viewChangeCounter === r) &&
                      (console.log('RESULT', t),
                      (n.payload = t),
                      e.dispatch({ type: s.ASYNC_END, promise: n.payload }),
                      e.dispatch(n));
                  },
                  function (t) {
                    var o = e.getState();
        ...
        l = function (e) {
          return function (e) {
            return function (t) {
              t.type === s.REGISTER || t.type === s.LOGIN
                ? t.error ||
                  (window.localStorage.setItem('jwt', t.payload.user.token),
                  i.default.setToken(t.payload.user.token))
                : t.type === s.LOGOUT &&
                  (window.localStorage.setItem('jwt', ''),
                  i.default.setToken(null)),
                e(t);
            };
          };
        };
        ...
        switch (t.type) {
          ...
          case r.ADD_COMMENT:
            return Object.assign({}, e, {
              ...
              comments: t.error
                ? null
                : (e.comments || []).concat([t.payload.comment]),
            });
      ...
      t.default = function () {
        ...
        switch (t.type) {
          ...
          case o.REGISTER_PAGE_UNLOADED:
            return {};
          case o.ASYNC_START:
            if (t.subtype === o.LOGIN || t.subtype === o.REGISTER)
              return Object.assign({}, e, { inProgress: !0 });
            break;
    ...
    function (e, t, n) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 });
      var r = n(5),
        o = { appName: 'Conduit', token: null, viewChangeCounter: 0 };
      t.default = function () {
        var e =
        ...
        switch (t.type) {
          ...
          case r.REDIRECT:
            return Object.assign({}, e, { redirectTo: null });
          case r.LOGOUT:
            return Object.assign({}, e, {
              redirectTo: '/',
              token: null,
          ...
          case r.ARTICLE_SUBMITTED:
            ...
            return Object.assign({}, e, { redirectTo: n });
          ...
          case r.DELETE_ARTICLE:
            return Object.assign({}, e, { redirectTo: '/' });
          case r.ARTICLE_PAGE_UNLOADED:
    ...
    function (e, t, n) {
      ...
      t.default = function () {
        ...
        switch (t.type) {
          ...
          case o.ASYNC_START:
            if (t.subtype === o.ARTICLE_SUBMITTED)
              return Object.assign({}, e, { inProgress: !0 });
            break;
          case o.ADD_TAG:
            return Object.assign({}, e, {
    ...
    function (e, t, n) {
      ...
      t.default = function () {
        ...
        switch (t.type) {
          case r.HOME_PAGE_LOADED:
            return Object.assign({}, e, { tags: t.payload[0].tags });
          case r.HOME_PAGE_UNLOADED:
            return {};
          default:
            return e;
      ...
      (function (t) {
        (function () {
          ...
          (p.bullet = /(?:[*+-]|\d+\.)/),
            ...
            (p.list = s(p.list)(/bull/g, p.bullet)(
              'hr',
              '\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))',
            )('def', '\\n+(?=' + p.def.source + ')')()),
            ...
            (p.paragraph = s(p.paragraph)('hr', p.hr)('heading', p.heading)(
              'lheading',
              p.lheading,
          ...
          switch (typeof t) {
            ...
            case 'object':
              ...
              var o,
                a = r.call(t);
              if (r !== t.entries) {
                for (; !(o = a.next()).done; ) if (!C(o.value)) return !1;
              } else
                for (; !(o = a.next()).done; ) {
                  var i = o.value;
                  if (i && !C(i[1])) return !1;
        ...
        if (
          (_
            ...
            : k
              ...
              : i(e, n) && (o = T.compositionStart),
          !o)
        )
          return null;
        C &&
          (k || o !== T.compositionStart
            ? o === T.compositionEnd && k && (l = k.getData())
            : (k = m.getPooled(r)));
    ...
    function (e, t, n) {
      ...
      C.canUseDOM &&
        (I =
          A('input') && (!document.documentMode || document.documentMode > 9));
      var L = {
        eventTypes: N,
        ...
        extractEvents: function (e, t, n, a) {
          var i,
            s,
            u = t ? O.getNodeFromInstance(t) : window;
          if (
            (o(u)
              ? D
                ? (i = c)
          ...
          updateComponent: function (e, t, n, r, o) {
            ...
            this._pendingForceUpdate ||
              (a.shouldComponentUpdate
                ? (f = a.shouldComponentUpdate(c, p, i))
                : this._compositeType === b.PureClass &&
                  (f = !y(l, c) || !y(a.state, p))),
              (this._updateBatchNumber = null),
              f
        ...
        (m.Mixin = {
          ...
          _updateDOMProperties: function (e, t, n) {
            ...
            for (r in t) {
              var u = t[r],
                l =
                  r === W ? this._previousStyleCopy : null != e ? e[r] : void 0;
              if (t.hasOwnProperty(r) && u !== l && (null != u || null != l))
                if (r === W)
                  ...
                  u ? a(this, r, u, n) : l && U(this, r);
                else if (h(this._tag, t))
                  G.hasOwnProperty(r) || C.setValueForAttribute(F(this), r, u);
        ...
        mountComponent: function (e, t, n, r) {
          ...
          if (((this._domID = o), (this._hostParent = t), e.useCreateElement)) {
            ...
            return (
              i.queueChild(d, i(p)),
              this._stringText &&
                i.queueChild(d, i(c.createTextNode(this._stringText))),
              i.queueChild(d, i(f)),
    ...
    function (e, t, n) {
      ...
      (t.default = d),
        ...
        (d.childContextTypes = { store: p.default.isRequired });
    },
    function (e, t, n) {
      'use strict';
      function r(e) {
            ...
            r = (function (r) {
              ...
              return (
                  ...
                  if (this.unsubscribe) {
                    ...
                    if (!b || t !== e) {
                      if (b && !this.doStatePropsDependOnOwnProps) {
                        ...
                        if (!n) return;
                        n === x &&
                          (this.statePropsPrecalculationError = x.value),
                ...
                (s.prototype.render = function () {
                  ...
                  var f = !0;
                  return (
                    (f = !!(u || l || t) && this.updateMergedPropsIfNeeded()),
                    !f && a
                      ? a
                      : (w
    ...
    function (e, t, n) {
          ...
          function t() {
            ...
            return (
              ...
              (r.handleLocationChange = function (e) {
                r.store.dispatch({ type: f.LOCATION_CHANGE, payload: e });
              }),
              (i = n),
              a(r, i)
            );
      ...
      (d.propTypes = {
        ...
        (d.contextTypes = { store: c.default.object }),
        (t.default = d);
    },
    function (e, t, n) {
      'use strict';
      ...
      (function (e) {
        !(function (e, n) {
          ...
          function c(e, t, n, r, p, f, d) {
            ...
            if ('undefined' != typeof f) {
              if (r) {
                ...
                if (
                  'object' === ('undefined' == typeof r ? 'undefined' : S(r))
                ) {
          ...
          function w(e, t) {
            ...
            e.forEach(function (o, p) {
              ...
              try {
                C
                  ? s.title && c
                    ? n.groupCollapsed.apply(n, ['%c ' + x].concat(T))
                    : n.groupCollapsed(x)
                  : s.title && c
                    ? n.group.apply(n, ['%c ' + x].concat(T))
                    : n.group(x);
              } catch (e) {
                n.log(x);
              }
          ...
          var O,
            ...
            R = [];
          (O =
            'object' === ('undefined' == typeof e ? 'undefined' : S(e)) && e
              ? e
              : 'undefined' != typeof window
                ? window
                : {}),
    ...
    function (e, t, n) {
      ...
      function i(e) {
        for (
          var t, n, r = {}, o = e.split('&'), a = 0, i = o.length;
          a < i;
          ++a
        )
          (t = o[a]),
          ...
          this.on('end', function () {
            ...
            try {
              ...
              return (
                ...
                (e.original = t),
                (e.rawResponse =
                  n.xhr && n.xhr.responseText ? n.xhr.responseText : null),
      ...
      (g.serializeObject = o),
        ...
        (p.prototype._parseBody = function (e) {
          ...
          return (
            !t && u(this.type) && (t = g.parse['application/json']),
      ...
      (f.prototype.type = function (e) {
        ...
        (f.prototype.end = function (e) {
          ...
          if (this.hasListeners('progress'))
            try {
              (n.onprogress = i.bind(null, 'download')),
                n.upload && (n.upload.onprogress = i.bind(null, 'upload'));
            } catch (e) {}
          if (
            (o &&
              !this._timer &&
            ...
            !l && u(s) && (l = g.serialize['application/json']),
              l && (a = l(a));
          }
